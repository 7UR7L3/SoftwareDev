...
#url accessed at:
#http://localhost:8000/cgi-bin/Michael_Rahn_HW4.py
...
print( '''<html>
	<head>
		...
		.shadow
		{
			filter: drop-shadow( 0px 10px 35px #000 );
		}
		</style>
	</head>
	<body>
		Temperatures by Capital<br />
		Across the Country
		<div id="container">
<svg class="shadow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 700">
...
# via https://github.com/tdlm/fun-with-python/blob/master/states_and_capitals.py and google's geocoder:
states_caps = [
[ "Olympia", "WA", "47.0378741", "-122.9006951" ],
[ "Madison", "WI", "43.0730517", "-89.4012302" ],
[ "Charleston", "WV", "38.3498195", "-81.6326234" ],
[ "Tallahassee", "FL", "30.4382559", "-84.28073289999999" ],
[ "Cheyenne", "WY", "41.1399814", "-104.8202462" ],
# [ "Concord", "NH", "43.2081366", "-71.5375718" ],
# [ "Trenton", "NJ", "40.2170534", "-74.7429384" ],
# [ "Santa Fe", "NM", "35.6869752", "-105.937799" ],
# [ "Raleigh", "NC", "35.7795897", "-78.6381787" ],
# [ "Bismarck", "ND", "46.8083268", "-100.7837392" ],
# [ "Lincoln", "NE", "40.8257625", "-96.6851982" ],
# [ "Albany", "NY", "42.6525793", "-73.7562317" ],
# [ "Providence", "RI", "41.8239891", "-71.4128343" ],
# [ "Carson City", "NV", "39.1637984", "-119.7674034" ],
# [ "Denver", "CO", "39.7392358", "-104.990251" ],
# [ "Sacramento", "CA", "38.5815719", "-121.4943996" ],
# [ "Atlanta", "GA", "33.7489954", "-84.3879824" ],
# [ "Hartford", "CT", "41.76371109999999", "-72.6850932" ],
# [ "Oklahoma City", "OK", "35.4675602", "-97.5164276" ],
# [ "Columbus", "OH", "39.9611755", "-82.99879419999999" ],
# [ "Topeka", "KS", "39.0558235", "-95.68901849999999" ],
# [ "Columbia", "SC", "34.0007104", "-81.0348144" ],
# [ "Frankfort", "KY", "38.2009055", "-84.87328350000001" ],
# [ "Salem", "OR", "44.9428975", "-123.0350963" ],
# [ "Pierre", "SD", "44.3683156", "-100.3509665" ],
# [ "Dover", "DE", "39.158168", "-75.5243682" ],
# [ "Honolulu", "HI", "21.3069444", "-157.8583333" ],
# [ "Austin", "TX", "30.267153", "-97.7430608" ],
# [ "Baton Rouge", "LA", "30.4582829", "-91.1403196" ],
# [ "Nashville", "TN", "36.1626638", "-86.7816016" ],
# [ "Harrisburg", "PA", "40.2731911", "-76.8867008" ],
# [ "Richmond", "VA", "37.5407246", "-77.4360481" ],
# [ "Juneau", "AK", "58.3019444", "-134.4197222" ],
# [ "Montgomery", "AL", "32.3668052", "-86.2999689" ],
# [ "Little Rock", "AR", "34.7464809", "-92.28959479999999" ],
# [ "Montpelier", "VT", "44.26005929999999", "-72.5753869" ],
# [ "Springfield", "IL", "39.78172130000001", "-89.6501481" ],
# [ "Indianapolis", "IN", "39.768403", "-86.158068" ],
# [ "Des Moines", "IA", "41.6005448", "-93.6091064" ],
# [ "Phoenix", "AZ", "33.4483771", "-112.0740373" ],
# [ "Boise", "ID", "43.6187102", "-116.2146068" ],
# [ "Augusta", "ME", "44.3106241", "-69.7794897" ],
# [ "Annapolis", "MD", "38.9784453", "-76.4921829" ],
# [ "Boston", "MA", "42.3600825", "-71.0588801" ],
# [ "Salt Lake City", "UT", "40.7607793", "-111.8910474" ],
# [ "Jefferson City", "MO", "38.57670170000001", "-92.1735164" ],
# [ "Saint Paul", "MN", "44.9537029", "-93.0899578" ],
# [ "Lansing", "MI", "42.732535", "-84.5555347" ],
# [ "Helena", "MT", "46.5883707", "-112.0245054" ],
# [ "Jackson", "MS", "32.2987573", "-90.1848103" ],
]

print( "<script>$( document ).ready( function(){" )

for temp in states_caps:
	# via http://stackoverflow.com/a/13921930 :
	response = urllib2.urlopen( "https://api.forecast.io/forecast/2d2a0f9ef782a08cc0282ba42fdf196b/" + temp[2] + "," + temp[3] + "?UNITS=us" )
	f = json.load( response )['currently']['temperature']
	if f > 80:
		print( "$('#" + temp[1] + "').css('fill', 'red')" )
	elif f > 50:
		print( "$('#" + temp[1] + "').css('fill', 'orange')" )
	elif f > 30:
		print( "$('#" + temp[1] + "').css('fill', 'green');" )
	elif f > 10:
		print( "$('#" + temp[1] + "').css('fill', 'cyan')" )
	else:
		print( "$('#" + temp[1] + "').css('fill', 'blue')" )
